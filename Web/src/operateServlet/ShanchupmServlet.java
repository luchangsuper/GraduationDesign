...
/**
 * Servlet implementation class ShanchupmServlet
 */
@WebServlet("/android/shanchupm")
public class ShanchupmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShanchupmServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			...
			if(rows>=no)
			{
				String str="delete from SalerInfo where 拍卖者编号="+delno;
				try {
					mydel.excuteSql(str);
					flag=1;
					if(flag==1)
