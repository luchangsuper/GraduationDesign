...
/**
 * Servlet implementation class BidedGoodsIndex
 */
@WebServlet("/android/bided")
public class BidedGoodsIndex extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BidedGoodsIndex() {
        super();
...
//		String sql="select * from BidedGoodsInfo where 我的姓名="+"'"+hanziname+"'";
		String sql="select * from BidedGoodsInfo";
		ResultSet rset;
